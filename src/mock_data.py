...
""",
            "evidence_graph_data": {
                "nodes": [
                    {"id": "rq_1", "type": "question", "label": "What are the trade-offs of RAG vs fine-tuning for enterprise LLMs?", "data": {}},
                    {"id": "claim_1", "type": "claim", "label": "RAG reduces hallucinations by 43%", "data": {"verification_status": "PASS", "confidence": 0.94}},
                    {"id": "claim_2", "type": "claim", "label": "LoRA reduces parameters by 10,000x", "data": {"verification_status": "PASS", "confidence": 0.98}},
                    {"id": "claim_3", "type": "claim", "label": "Hybrid RAG + LoRA yields highest accuracy", "data": {"verification_status": "PASS", "confidence": 0.91}},
                    {"id": "paper_1", "type": "paper", "label": "Lewis et al. (2020) NeurIPS", "data": {"source_type": "paper"}},
                    {"id": "paper_2", "type": "paper", "label": "Hu et al. (2021) ICLR", "data": {"source_type": "paper"}},
                    {"id": "paper_3", "type": "paper", "label": "Xu et al. (2024) ACL", "data": {"source_type": "paper"}},
                    {"id": "contra_1", "type": "contradiction", "label": "RAG retrieval latency negates LoRA's inference speed gains under load", "data": {}},
                ],
                "edges": [
                    {"id": "e1", "source": "paper_1", "target": "claim_1", "type": "supports"},
                    {"id": "e2", "source": "paper_2", "target": "claim_2", "type": "supports"},
                    {"id": "e3", "source": "paper_3", "target": "claim_3", "type": "supports"},
                    {"id": "e4", "source": "claim_1", "target": "claim_3", "type": "supports"},
                    {"id": "e5", "source": "contra_1", "target": "claim_2", "type": "contradicts"},
                ],
            },
        },
    },
...
""",
            "evidence_graph_data": {
                "nodes": [
                    {"id": "rq_if", "type": "question", "label": "Does intermittent fasting improve metabolic health markers?", "data": {}},
                    {"id": "claim_if_1", "type": "claim", "label": "Metabolic switch to ketone utilization", "data": {"verification_status": "PASS", "confidence": 0.96}},
                    {"id": "claim_if_2", "type": "claim", "label": "10h TRE reduces HbA1c by ~0.5%", "data": {"verification_status": "PASS", "confidence": 0.93}},
                    {"id": "claim_if_3", "type": "claim", "label": "Weight loss driven by net caloric reduction", "data": {"verification_status": "PASS", "confidence": 0.89}},
                    {"id": "paper_if_1", "type": "paper", "label": "de Cabo & Mattson (2019) NEJM", "data": {"source_type": "paper"}},
                    {"id": "paper_if_2", "type": "paper", "label": "Suryanarayana et al. (2022) Cell Met", "data": {"source_type": "paper"}},
                    {"id": "paper_if_3", "type": "paper", "label": "Weiss et al. (2021) JAMA Int Med", "data": {"source_type": "paper"}},
                ],
                "edges": [
                    {"id": "e_if1", "source": "paper_if_1", "target": "claim_if_1", "type": "supports"},
                    {"id": "e_if2", "source": "paper_if_2", "target": "claim_if_2", "type": "supports"},
                    {"id": "e_if3", "source": "paper_if_3", "target": "claim_if_3", "type": "supports"},
                ],
            },
        },
    },
...
""",
            "evidence_graph_data": {
                "nodes": [
                    {"id": "rq_qc", "type": "question", "label": "Are quantum computing algorithms superior for supply chain optimization?", "data": {}},
                    {"id": "claim_qc_1", "type": "claim", "label": "Theoretical QAOA speedup for routing", "data": {"verification_status": "PASS", "confidence": 0.92}},
                    {"id": "claim_qc_2", "type": "claim", "label": "Classical Gurobi outperforms NISQ hardware", "data": {"verification_status": "PASS", "confidence": 0.97}},
                    {"id": "paper_qc_1", "type": "paper", "label": "Farhi et al. (2022)", "data": {"source_type": "paper"}},
                    {"id": "paper_qc_2", "type": "paper", "label": "Tanaka et al. (2023) IEEE", "data": {"source_type": "paper"}},
                ],
                "edges": [
                    {"id": "e_qc1", "source": "paper_qc_1", "target": "claim_qc_1", "type": "supports"},
                    {"id": "e_qc2", "source": "paper_qc_2", "target": "claim_qc_2", "type": "supports"},
                    {"id": "e_qc3", "source": "claim_qc_2", "target": "claim_qc_1", "type": "contradicts"},
                ],
            },
        },
    },
