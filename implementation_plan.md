# Implementation Plan - Verity Evidence-Grounded Research Agent Refactor

This plan outlines the architecture, code refactoring, data models, state graph topology, and agent implementation required to repurpose the existing multi-agent infrastructure into **Verity — Evidence-Grounded Research Agent**.
...
#### [NEW] [src/core/schemas.py](file:///home/adi/Desktop/Hackathons/research-agent/src/core/schemas.py)
...
#### [MODIFY] [src/core/state.py](file:///home/adi/Desktop/Hackathons/research-agent/src/core/state.py)
...
#### [NEW] [src/agents/planner_agent.py](file:///home/adi/Desktop/Hackathons/research-agent/src/agents/planner_agent.py) *(Replaces hypothesis_agent)*
- Takes research question; generates research plan, subquestions, initial hypotheses, and search queries.

#### [NEW] [src/agents/supervisor_agent.py](file:///home/adi/Desktop/Hackathons/research-agent/src/agents/supervisor_agent.py) *(Replaces process_agent)*
...
#### [NEW] [src/agents/literature_agent.py](file:///home/adi/Desktop/Hackathons/research-agent/src/agents/literature_agent.py) *(Replaces search_agent)*
...
#### [NEW] [src/agents/extractor_agent.py](file:///home/adi/Desktop/Hackathons/research-agent/src/agents/extractor_agent.py) *(Replaces code_agent)*
- Extracts granular claims, empirical evidence, numerical results, and methodology snippets from retrieved literature.

#### [NEW] [src/agents/challenger_agent.py](file:///home/adi/Desktop/Hackathons/research-agent/src/agents/challenger_agent.py) *(NEW Agent)*
- Performs targeted counter-search for conflicting evidence, negative findings, alternative explanations, and limitations.

#### [NEW] [src/agents/verifier_agent.py](file:///home/adi/Desktop/Hackathons/research-agent/src/agents/verifier_agent.py) *(Replaces quality_review_agent)*
- Rigorously validates claims against source evidence and citations; labels each as `PASS`, `FAIL`, or `UNCERTAIN`.

#### [NEW] [src/agents/ledger_agent.py](file:///home/adi/Desktop/Hackathons/research-agent/src/agents/ledger_agent.py) *(Replaces note_agent)*
- Maintains state updates, structures paper/claim/evidence entries in research ledger, and tracks execution cost.

#### [NEW] [src/agents/evidence_graph_agent.py](file:///home/adi/Desktop/Hackathons/research-agent/src/agents/evidence_graph_agent.py) *(Replaces visualization_agent)*
...
#### [NEW] [src/agents/synthesizer_agent.py](file:///home/adi/Desktop/Hackathons/research-agent/src/agents/synthesizer_agent.py) *(Replaces report_agent)*
...
- Remove old CSV data analysis agents (`hypothesis_agent.py`, `code_agent.py`, `visualization_agent.py`, `quality_review_agent.py`, `report_agent.py`, `note_agent.py`, `process_agent.py`, `search_agent.py`).

---

### LangGraph Workflow & Routing

#### [MODIFY] [src/core/workflow.py](file:///home/adi/Desktop/Hackathons/research-agent/src/core/workflow.py)
...
#### [MODIFY] [src/core/node.py](file:///home/adi/Desktop/Hackathons/research-agent/src/core/node.py) & [src/core/router.py](file:///home/adi/Desktop/Hackathons/research-agent/src/core/router.py)
...
#### [MODIFY] [config/agent_models.yaml](file:///home/adi/Desktop/Hackathons/research-agent/config/agent_models.yaml)
...
#### [NEW] [config/agents/](file:///home/adi/Desktop/Hackathons/research-agent/config/agents/)
...
#### [MODIFY] [main.py](file:///home/adi/Desktop/Hackathons/research-agent/main.py)
...
#### [NEW] [src/api.py](file:///home/adi/Desktop/Hackathons/research-agent/src/api.py)
...
#### [MODIFY] [requirements.txt](file:///home/adi/Desktop/Hackathons/research-agent/requirements.txt)
- Add `fastapi`, `uvicorn[standard]`, `sse-starlette` dependencies.

---

### Frontend — Verity UI (Next.js)

> [!IMPORTANT]
> The frontend is a Next.js app living in [frontend/](file:///home/adi/Desktop/Hackathons/research-agent/frontend/). It connects to the FastAPI backend via REST + SSE. The UI follows a **progressive disclosure model**: Normal users see `Question → Research → Clean Report`. Advanced users can inspect agent actions, evidence graphs, and verification decisions.
...
#### [NEW] [frontend/src/app/page.tsx](file:///home/adi/Desktop/Hackathons/research-agent/frontend/src/app/page.tsx) — **Main Dashboard** `/`
- Left sidebar: Verity logo, New Research, Research History, Saved Reports, Settings links.
...
#### [NEW] [frontend/src/app/research/new/page.tsx](file:///home/adi/Desktop/Hackathons/research-agent/frontend/src/app/research/new/page.tsx) — **Research Configuration** `/research/new`
...
#### [NEW] [frontend/src/app/research/[id]/run/page.tsx](file:///home/adi/Desktop/Hackathons/research-agent/frontend/src/app/research/%5Bid%5D/run/page.tsx) — **Live Research Canvas** `/research/:id/run`
...
#### [NEW] [frontend/src/app/research/[id]/run/[agent]/page.tsx](file:///home/adi/Desktop/Hackathons/research-agent/frontend/src/app/research/%5Bid%5D/run/%5Bagent%5D/page.tsx) — **Agent Inspector** `/research/:id/run/:agent`
...
#### [NEW] [frontend/src/app/research/[id]/graph/page.tsx](file:///home/adi/Desktop/Hackathons/research-agent/frontend/src/app/research/%5Bid%5D/graph/page.tsx) — **Evidence Graph** `/research/:id/graph`
...
#### [NEW] [frontend/src/app/research/[id]/page.tsx](file:///home/adi/Desktop/Hackathons/research-agent/frontend/src/app/research/%5Bid%5D/page.tsx) — **Final Research Report** `/research/:id`
...
#### [NEW] [frontend/src/app/history/page.tsx](file:///home/adi/Desktop/Hackathons/research-agent/frontend/src/app/history/page.tsx) — **Research History** `/history`
- Research cards: title, status, source count, date, runtime, open button.
- Filter tabs: All / Running / Completed / Failed.

#### [NEW] [frontend/src/app/settings/page.tsx](file:///home/adi/Desktop/Hackathons/research-agent/frontend/src/app/settings/page.tsx) — **Settings** `/settings`
...
```mermaid
graph TD
    A["Dashboard /"] --> B["New Research /research/new"]
    A --> C["History /history"]
    A --> D["Settings /settings"]
    B --> E["Live Research /research/:id/run"]
    E --> F["Agent Inspector /research/:id/run/:agent"]
    E --> G["Evidence Graph /research/:id/graph"]
    E --> H["Final Report /research/:id"]
    H --> G
```

---

### Visibility Model (Progressive Disclosure)

| Level | User Type | What They See |
|-------|-----------|---------------|
| **Level 1** | Normal User | Question → Research → Clean Report |
| **Level 2** | Researcher | Report → Click Claim → Evidence → Source Paper |
| **Level 3** | Advanced / Judge | Live Agent Graph → Agent Actions → Verification Decisions → Failures/Recovery → Cost + Runtime |
...
1. Data models & schemas (`src/core/schemas.py`)
2. Updated state (`src/core/state.py`)
3. All 9 agent modules (planner through synthesizer)
4. LangGraph workflow & routing updates
5. Agent configurations & system prompts
6. FastAPI backend (`src/api.py`) with SSE streaming

### Phase 2 — Frontend MVP
1. Main Dashboard
2. Research Configuration page
3. Live Research Canvas (n8n-style agent flow with real-time SSE)
4. Final Research Report page
5. Evidence Graph with embedded evidence inspection
...
5. Design polish, animations, and responsive layout
...
- Run test suite: `/home/adi/Desktop/Hackathons/research-agent/.venv/bin/python -m unittest discover tests`
- Verify imports & schema models: `/home/adi/Desktop/Hackathons/research-agent/.venv/bin/python -c "from src.core.schemas import ResearchQuestion, Claim, Evidence; print('Schemas valid')"`
- Verify FastAPI starts: `/home/adi/Desktop/Hackathons/research-agent/.venv/bin/python -m uvicorn src.api:app --port 8000`
